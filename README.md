...
The default [Sapper](https://github.com/sveltejs/sapper) template that I use in my project, with branches for Rollup and webpack. To clone it and get started:

## What's Included 

- Tailwind CSS
- Prettier and Eslint auto formating
- Svelte3 Auto formating
- SCSS Preprocesser

## What's Needed
- VSCode
- [svelte-vscode](https://github.com/UnwrittenFun/svelte-vscode)
- [vscode-svelte-snippets](https://github.com/fivethree-team/vscode-svelte-snippets)
